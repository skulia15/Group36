...
public:
    ...
    void setupUi(QDialog *AddComputerDialog)
    {
        ...
        input_computer_type->setGeometry(QRect(10, 210, 241, 20));
        ...
        label_computer_type->setGeometry(QRect(9, 125, 241, 18));
        ...
        label_error_computer_name->setGeometry(QRect(180, 70, 211, 16));
        ...
        label_input_label_computer->setGeometry(QRect(9, 69, 221, 18));
