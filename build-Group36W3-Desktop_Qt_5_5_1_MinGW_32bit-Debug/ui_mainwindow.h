...
public:
    ...
    QListWidget *list_display_scientists;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        list_display_scientists = new QListWidget(centralWidget);
        list_display_scientists->setObjectName(QStringLiteral("list_display_scientists"));

        verticalLayout->addWidget(list_display_scientists);
